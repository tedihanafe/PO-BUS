        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-success btn-user btn-block mt-4 p-2" style="font-size: 16px">
                        <a href="/history" style="color: white; text-decoration: none;">Cek Pesanan</a>
                    </button>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\PROJECT LARAVEL\PEMESANAN-TIKET-LARAVEL8\resources\views/client/index.blade.php ENDPATH**/ ?>